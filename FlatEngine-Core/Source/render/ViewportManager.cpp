...
namespace FlatEngine
{
	...
	{      
        m_viewportDescriptorSets.resize(VulkanManager::MAX_FRAMES_IN_FLIGHT);
	}
    ...
    // void ViewportManager::Setup(VkCommandPool& commandPool)
    // {
    //     PipelineManager::Setup(commandPool);
    ...
    //    std::shared_ptr<Material> imguiMaterial = VulkanManager::vulkan.GetMaterial("imgui");
    ...
    //    VkSampleCountFlagBits msaaSamples = VK_SAMPLE_COUNT_1_BIT;// VulkanManager::vulkan.GetMaxSamples();
