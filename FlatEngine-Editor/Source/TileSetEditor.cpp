...
// {
    ...
    // Moved from FlatGui.h, need to make a TileSetEditor.h and put these there
	// extern std::string FG_currentSelectedColliderArea;
	// extern std::vector<std::pair<Vector2, Vector2>> FG_collisionAreasBuffer;


// 	void RenderTileSetEditor(bool& b_showTileSetEditor)
// 	{
// 		Vector2 centerPoint;
...
// 		if (FL::GuiCore::BeginWindow("Tileset Editor", b_showTileSetEditor))
// 		{

// 			FL::GuiCore::BeginResizeWindowChild("Toolbar");
// 			// {

// 				if (FL::GuiCore::RenderButton("New TileSet"))
// 				{
...
// 							ImGui::PushStyleColor(ImGuiCol_FrameBg, FL::Assets::GetColor("outerWindow"));
...
// 						if (FL::GuiCore::DropInputCanOpenFiles("##TileSetSource", "File", FL::FileHelper::GetFilenameFromPath(tileSetTexturePath, true), FL::F_fileExplorerTarget, droppedValue, tileSetTexturePath, "Drop images here from the File Explorer"))
// 						{							
...
// 				if (FL::GuiCore::RenderInputModal("Create New TileSet", "Enter a name for the TileSet", tileSetName, b_openTileSetModal))
// 				{
// 					FL::CreateNewTileSetFile(tileSetName, FL::Assets::GetDir("tileSets"));
// 				}

// 			// }
// 			FL::GuiCore::EndWindowChild(); // Toolbar
...
// 			FL::GuiCore::BeginWindowChild("Gridspace", FL::Assets::GetColor("outerWindow"), 16 | 8); // No Scrolling flags 
// 			// {
...
// 					int renderOrder = 1;
// 					Vector4 tintColor = FL::Assets::GetColor("white");
...
// 			// }
// 			FL::GuiCore::EndWindowChild(); // Gridspace

// 			FL::GuiCore::EndWindow(); // Tileset Editor
// 		}		
// 	}
...
// 		// AddSceneViewMouseControls(invisibleButtonID, tileStart, Vector2(tileWidthInPx, tileHeightInPx), scrolling, gridStart, step, FL::Assets::GetColor32("tileSetTileBorder"));
...
// 		// if (b_isHovered)
// 		// {
// 		// 	ImGui::GetWindowDrawList()->AddRectFilled(tileStart, tileEnd, FL::Assets::GetColor32("tileSetHoveredTile"));
// 		// 	ImGui::GetWindowDrawList()->AddRect(tileStart, tileEnd, FL::Assets::GetColor32("tileSetHoveredTileBorder"));
// 		// }
// 		// else if (b_selected)
// 		// {
// 		// 	ImGui::GetWindowDrawList()->AddRectFilled(tileStart, tileEnd, FL::Assets::GetColor32("tileSetSelectedTile"));
// 		// }
// 		// if (b_isClicked)
// 		// {
...
// 		// if (b_isActive)
// 		// {
// 		// 	ImGui::GetWindowDrawList()->AddRectFilled(tileStart, tileEnd, FL::Assets::GetColor32("tileSetHoldingTile"));
// 		// }
// 	}
// }